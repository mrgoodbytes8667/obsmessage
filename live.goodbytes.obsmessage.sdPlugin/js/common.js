    ...
    */
    ...
    function init () {
        ...
        function connect (args) {
            ...
            console.log('--- Common Connected ---', args);
            ...
            websocket.onmessage = function (evt) {
                ...
                console.log('[STREAMDECK] websocket.onmessage ... ', jsonObj, jsonObj.event);
...
const SDApi = {
    ...
    common: {
        ...
        getGlobalSettings: function () {
            SDApi.send($SD.uuid, 'getGlobalSettings');
        },

        setGlobalSettings: function (payload) {
            SDApi.send($SD.uuid, 'setGlobalSettings', {
                payload: payload
            });
        }
